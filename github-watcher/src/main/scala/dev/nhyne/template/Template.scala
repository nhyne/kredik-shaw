package dev.nhyne.template

import com.coralogix.zio.k8s.client.K8sFailure
import dev.nhyne.template.RepoConfig.ImageTag
...
import com.coralogix.zio.k8s.client.apps.v1.deployments.{Deployments, getAll, replace}
...
import dev.nhyne.commandToKredikString
